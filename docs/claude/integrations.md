...
Sales agents use the **Attio MCP server** (stdio-based, `attio-mcp` npm package) for full CRM access. Configured in `meshwork-plugin/.mcp.json`.
...
- Reads `skills/meshwork-brand/SKILL.md` before any work
...
- summary: Build dashboard UI components
  ...
  description: |
    ...
    Follow Meshwork brand guidelines.
