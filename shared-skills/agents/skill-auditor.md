...
- `PLUGIN_DIR`: absolute path to the product plugin directory, e.g. `/srv/certpilot-autodev/myproduct-plugin`
- `WORKING_DIR`: absolute path to the product codebase, e.g. `/srv/projects/myproduct`
- `JIRA_PROJECT_KEY`: e.g. `APP`
- `SHARED_SKILLS_DIR`: absolute path to shared-skills, e.g. `/srv/certpilot-autodev/shared-skills`
- `AUTODEV_DIR`: absolute path to CertPilot-AutoDev, e.g. `/srv/certpilot-autodev`
