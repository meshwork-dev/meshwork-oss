    ...
    <div className="space-y-5">
      <Card>
        ...
        <p className="text-sm text-zinc-300 leading-relaxed">
          CertPilot connects <strong className="text-white">Jira</strong>, <strong className="text-white">Slack</strong>, <strong className="text-white">N8N</strong>, and <strong className="text-white">Claude Code</strong> into
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-0.5">How to use CertPilot automation — triggers, agents, pipelines, and API</p>
      </div>
